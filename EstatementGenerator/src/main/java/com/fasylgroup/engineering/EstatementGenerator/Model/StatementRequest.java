...
public class StatementRequest {
    ...
    public com.fasylgroup.engineering.EstatementGenerator.Model.SttbScheduledStatements getSttbScheduledStatements() {
        return SttbScheduledStatements;
    }

    public void setSttbScheduledStatements(com.fasylgroup.engineering.EstatementGenerator.Model.SttbScheduledStatements sttbScheduledStatements) {
    ...
    public com.fasylgroup.engineering.EstatementGenerator.Model.TransactionStatistics getTransactionStatistics() {
        return TransactionStatistics;
    }

    public void setTransactionStatistics(com.fasylgroup.engineering.EstatementGenerator.Model.TransactionStatistics transactionStatistics) {
